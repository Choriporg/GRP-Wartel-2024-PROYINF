...
def contrastar(imageList, umbral):
    # Crear una lista para almacenar las imágenes contrastadas
    imagenesContrastadas = []
    
    for imagen in imageList:
        imagen.pixel_array[imagen.pixel_array < umbral] = 0
        imagen.pixel_array[imagen.pixel_array >= umbral] = 255
